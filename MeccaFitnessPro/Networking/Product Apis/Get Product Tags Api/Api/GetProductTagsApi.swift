...
class GetProductTagsApi : ObservableObject{
    ...
    @Published var apiResponse :  GetProductTagsResponseModel?
    ...
    self.isApiCallDone = false
        ...
        //Create url
    guard let url = URL(string: NetworkConfig.baseUrl + NetworkConfig.getProductTags ) else {return}
    ...
    let task = URLSession.shared.dataTask(with: request) { data, response, error in
        ...
        DispatchQueue.main.async{
            ...
            do{
                ...
                print("Got product tags succesfully.....")
                
                self.isApiCallDone = true
                
                let main = try JSONDecoder().decode(GetProductTagsResponseModel.self, from: data)
