...
struct GetTransactionsDataModel : Codable{
    ...
    let per_page : Int
    let total : Int
    let transactions : [GetTransactionsTransactionModel]
    ...
    init(from decoder: Decoder) throws {
       ...
       do {
        ...
        do {
            transactions = try container.decode([GetTransactionsTransactionModel]?.self, forKey: .transactions) ?? []
        } catch  {
            transactions =  []
        }
...
struct GetTransactionsTransactionModel : Codable{
