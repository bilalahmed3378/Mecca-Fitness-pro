...
class AddShippingAddressApi : ObservableObject{
    ...
    @Published var apiResponse :  AddShippingAddressResponseModel?
    
    
    
    func addShippingAddress( address1 : String ,address2 : String , first_name : String , last_name : String , country : String , state : String , city : String , zip : String , country_code : String , email : String , phone : String , company : String , latitude : String , longitude : String){
        ...
        //Create url
        guard let url = URL(string: NetworkConfig.baseUrl + NetworkConfig.addShippingAddress) else {return}
        ...
        let task = URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            DispatchQueue.main.async{
                ...
                do{
                    ...
                    print("Got add shipping address response succesfully.....")
                    
                    self.isApiCallDone = true
                    
                    let main = try JSONDecoder().decode(AddShippingAddressResponseModel.self, from: data)
