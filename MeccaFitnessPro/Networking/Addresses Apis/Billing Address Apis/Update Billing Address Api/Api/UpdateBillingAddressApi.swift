...
class UpdateBillingAddressApi : ObservableObject{
    ...
    @Published var apiResponse :  UpdateBillingAddressResponseModel?
    
    
    
    func updateBillingAddress(billing_address_id  : String , address : String , first_name : String , last_name : String , country : String , state : String , city : String , zip : String , country_code : String , email : String , phone : String){
        ...
        //Create url
        guard let url = URL(string: NetworkConfig.baseUrl + NetworkConfig.updateBillingAddress) else {return}
        
        
        
        let formToRequest = MultipartForm(parts: [
            MultipartForm.Part(name: "billing_address_id", value: billing_address_id),
        ...
        let task = URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            DispatchQueue.main.async{
                ...
                do{
                    ...
                    print("Got update billing address response succesfully.....")
                    
                    self.isApiCallDone = true
                    
                    let main = try JSONDecoder().decode(UpdateBillingAddressResponseModel.self, from: data)
