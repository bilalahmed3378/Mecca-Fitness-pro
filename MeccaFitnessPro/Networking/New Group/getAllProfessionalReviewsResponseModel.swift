//
//  getAllProfessionalReviewsResponseModel.swift
//  MeccaFitnessPro
//
...
struct allProfessionalReviewsResponseModel : Codable{
    
    let status : String
    let code : Int
    let message : String
    let data : professionalReviewsDataModel?
    ...
    init(from decoder: Decoder) throws {
       ...
       do {
           data = try container.decode(professionalReviewsDataModel?.self, forKey: .data) ?? nil
       } catch  {
           data = nil
       }
...
struct professionalReviewsDataModel : Codable {
    ...
    let per_page : Int
    let total : Int
    let rating_details : professionaltReviewsRatingDetailsModel?
    ...
    init(from decoder: Decoder) throws {
       ...
       do {
        ...
        do {
            rating_details = try container.decode(professionaltReviewsRatingDetailsModel?.self, forKey: .rating_details) ?? nil
        } catch  {
            rating_details =  nil
        }
...
struct professionaltReviewsRatingDetailsModel : Codable {
    
    let total_rating : Int
    let total_reviews : Int
    let avg_rating : Double
    let rating_number_detail : professionalReviewsRatingDetailsRatingNumberDetailModel?
    let reviews : [professionaltReviewsRatingDetailsReviewModel]
    ...
    init(from decoder: Decoder) throws {
       ...
       let container = try decoder.container(keyedBy: CodingKeys.self)
        ...
        do {
            rating_number_detail = try container.decode(professionalReviewsRatingDetailsRatingNumberDetailModel?.self, forKey: .rating_number_detail) ?? nil
        } catch  {
            rating_number_detail = nil
        }
        
        do {
            reviews = try container.decode([professionaltReviewsRatingDetailsReviewModel]?.self, forKey: .reviews) ?? []
        } catch  {
            reviews = []
        }
...
struct professionalReviewsRatingDetailsRatingNumberDetailModel : Codable{
    ...
    init(from decoder: Decoder) throws {
        ...
        let container = try decoder.container(keyedBy: professionalReviewsRatingDetailsRatingNumberDetailModel.CodingKeys.self)
...
struct professionaltReviewsRatingDetailsReviewModel : Codable {
    
    let rating : Int
    let review : String
    let rating_at : String
    let rating_by : professionaltReviewsRatingDetailsReviewRatingByModel?
    ...
    init(from decoder: Decoder) throws {
       ...
       let container = try decoder.container(keyedBy: CodingKeys.self)
        ...
        do {
            rating_by = try container.decode(professionaltReviewsRatingDetailsReviewRatingByModel?.self, forKey: .rating_by) ?? nil
        } catch  {
            rating_by = nil
        }
...
struct professionaltReviewsRatingDetailsReviewRatingByModel : Codable {
