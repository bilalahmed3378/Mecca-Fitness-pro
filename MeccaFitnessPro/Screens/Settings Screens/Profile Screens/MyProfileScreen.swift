                        ...
                        VStack(spacing:0){
                            ...
                            Group{
                                ...
                                HStack{
                                    ...
                                    Text("The Gigalodon Hotel is a hotel that has dinner facilities beside a pool \(Text("read more ...").font(AppFonts.ceraPro_16).foregroundColor(AppColors.primaryColor))")
                                        .font(AppFonts.ceraPro_16)
                                        .foregroundColor(AppColors.textColorLight)
