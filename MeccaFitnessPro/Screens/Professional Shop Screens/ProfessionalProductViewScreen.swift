...
struct ProfessionalProductViewScreen: View {
    ...
    var body: some View {
        ...
        ZStack{
            ...
            NavigationLink(destination: ProfessionalProductDetailViewScreen(isFlowRootActive: self.$isFlowRootActive) , isActive: self.$pushDeatilView){
                EmptyView()
            }
...
//                    }
                ...
                VStack{
                    ...
                    NavigationLink(destination: ProfessionalProductDetailViewScreen(isFlowRootActive: self.$isFlowRootActive)){
                        
                        GradientButton(lable: "View More")
