//
//  ProfessionalShopScreen.swift
//  MeccaFitness
//
//  Created by CodeCue on 25/02/2022.
//

import SwiftUI

struct ProfessionalShopScreen: View {
                    ...
                    VStack{
                        ...
                        Group{
                            ...
                            HStack(alignment:.center){
                                ...
                                NavigationLink(destination: ProfessionalShopPoupularScreen(isFlowRootActive: self.$isPopularPurchaseFlowRootActive) , isActive : self.$isPopularPurchaseFlowRootActive ){
                                    Text("View All")
                            ...
                            ScrollView(.horizontal,showsIndicators: false){
                                ...
                                HStack{
                                    ForEach(0...10 , id:\.self){ index in
                                        NavigationLink(destination: ProfessionalProductViewScreen(isFlowRootActive: self.$isShopFlowActive), isActive: self.$isShopFlowActive){
                                            ItemCard()
                                        }
                                    }
                                }
                        ...
                        Group{
                            ...
                            HStack(alignment:.center){
                                ...
                                NavigationLink(destination: ProfessionalShopRecentScreen(isFlowRootActive: self.$isRecentPurchaseFlowRootActive) , isActive : self.$isRecentPurchaseFlowRootActive ){
                                    Text("View All")
                                        .font(AppFonts.ceraPro_12)
                                        .foregroundColor(AppColors.textColorLight)
                                }
