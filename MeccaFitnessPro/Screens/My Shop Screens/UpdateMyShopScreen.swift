...
struct UpdateMyShopScreen: View , MyLocationReceiver  {
    ...
    @Binding var isUpdateShopActive : Bool

    let shopDetails : ShopDetails?
    
    init(isUpdateShopActive : Binding<Bool> , shopDetails : ShopDetails? = nil){
        self._isUpdateShopActive = isUpdateShopActive
                ...
                ScrollView(.vertical,showsIndicators: false){
                                ...
                                HStack{
                                    ...
                                    TextField("Shop Category" , text: self.$shopCategory)
                                        ...
                                        .onChange(of: self.shopCategory) { newValue in
                                            self.shopCategory = newValue.limit(limit : 30)
                    ...
                    VStack(alignment: .leading , spacing: 5){
                        ...
                        TextField("Website", text: self.$web)
                            ...
                            .background(RoundedRectangle(cornerRadius: 10).fill(AppColors.textFieldBackgroundColor))
                            .cornerRadius(10)
                            .onChange(of: self.web) { newValue in
                                self.web = newValue.limit(limit : 40)
                            }
