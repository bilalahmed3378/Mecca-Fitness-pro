//
//  UpdateProductVariantsScreen.swift
//  MeccaFitnessPro
//
//  Created by Bilal Ahmed on 18/11/2022.
//

import SwiftUI
import Kingfisher

struct UpdateProductVariantsScreen : View {
    ...
    @StateObject var getProductDetails = GetProductDetailsApi()
                    ...
                    if(self.getVarinatsApi.dataRetrivedSuccessfully && self.getVarinatsApi.apiResponse != nil){
                        ...
                        ScrollView(.vertical , showsIndicators : false){
                            ...
                            Group{
                                ...
                                if(self.getProductDetailsApi.isApiCallDone && self.getProductDetailsApi.isApiCallSuccessful){
...
//                        .padding(.bottom,10)
        ...
        .onAppear{
            self.getVarinatsApi.getProductVariants()
            self.getProductDetailsApi.getProductDetails(product_id: Int(self.product_id) ?? 0)
...
private struct VariantSizes : View{
